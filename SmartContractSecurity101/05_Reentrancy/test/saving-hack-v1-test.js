...
describe("Reentrancy Attack on SavingsAccountV1", function () {
  ...
  beforeEach(async function () {
    ...
    this.investor = await AttackerContract.deploy(this.savingsAcct.address);
  });

  describe("Users using Saving_V1", function () {
    it("Should deposit() on Saving_V1", async function () {
    ...
    it("Should withdraw() on Saving_V1", async function () {
  ...
  describe("Attacking Saving_V1 from Attacker's Contract", function () {
    it("Should exploitSavingsAccount() on AttackerContract", async function () {
      ...
      await this.investor.exploitSavingsAccount({
